...
testsuite_run = db.Table('testsuite_run',
                         db.Column('id', db.Integer, primary_key=True),
...
tagmappingtestsuite = db.Table('tag_mapping_testsuite',
                               db.Column('id', db.Integer, primary_key=True),
